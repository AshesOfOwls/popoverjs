...
exports.PopoverjsReact = undefined;
...
exports.PopoverjsReact = _react2.default;
...
var Renderer = function () {
  ...
  _createClass(Renderer, [{
    ...
    key: 'isCursorWithinBoundaries',
    value: function isCursorWithinBoundaries() {
      var _options = this.options,
          attachmentElement = _options.attachmentElement,
          popoverElement = _options.popoverElement;

      var content = popoverElement.querySelector('.popoverjs-content');

      var contentRect = content.getBoundingClientRect();
      var attachmentRect = attachmentElement.getBoundingClientRect();
      ...
      var contentPolygon = [[contentRect.left, contentRect.top], [contentRect.left, contentRect.bottom], [contentRect.right, contentRect.bottom], [contentRect.right, contentRect.top]];

      return (0, _pointInPolygon2.default)(this.cursorPosition, polygon) || (0, _pointInPolygon2.default)(this.cursorPosition, attachmentPolygon) || (0, _pointInPolygon2.default)(this.cursorPosition, contentPolygon);
    }
  }, {
    key: 'onTriggerClick',
    ...
    key: 'elementInPopover',
    value: function elementInPopover(element) {
  ...
  _createClass(Popover, [{
    ...
    value: function createPopover() {
      ...
      if (element) {
        ...
        this.popoverjs = new _popover2.default(this.popoverOptions);
      }
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'popoverjs' },
          _react2.default.createElement('div', { className: 'popoverjs-arrow' }),
          _react2.default.createElement('div', { className: 'popoverjs-content' })
        )
      );
    }
  }, {
...
Popover.propTypes = {
  ...
  popoverOptions: _propTypes.object,
  themeClass: _propTypes.string
};
...
*/
var aa=__webpack_require__(7),l=__webpack_require__(11),B=__webpack_require__(2),C=__webpack_require__(1),ba=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(4);
